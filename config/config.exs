...
config :amboseli, AmboseliWeb.Endpoint,
  ...
  pubsub_server: Amboseli.PubSub,
  live_view: [signing_salt: "DFNPfF4a"]
...
config :amboseli, Amboseli.Mailer, adapter: Swoosh.Adapters.Local
