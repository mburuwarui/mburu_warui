...
config :amboseli, AmboseliWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/amboseli_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :amboseli, dev_routes: true, token_signing_secret: "J2CZDIGIxnipQH2jJSgMAMuJnvkppkBX"
